...
local head = "foxnormalhead"
local chest = "foxnormalchest"
local legs = "foxnormallegs"
local fullhead = nil
local fullchest = "foxnormalbellychest"
local fulllegs = "foxnormalbellylegs"
local victim = nil
