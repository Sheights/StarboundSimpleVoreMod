...
defaultDescription = " add text here"

defaultIcon = "/vehicles/spov/CREATURENAME/CREATURENAMEicon.png"

defaultFrame = "/vehicles/spov/CREATURENAME/CREATURENAME.png:idle.1"
