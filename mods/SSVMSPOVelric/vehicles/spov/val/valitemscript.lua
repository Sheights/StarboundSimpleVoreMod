...
defaultDescription = "Summon a big, friendly raptoress with a belly eager to keep you safe~"

defaultIcon = "/vehicles/spov/val/valdangericon.png"

defaultFrame = "/vehicles/spov/val/val.png:idle.1"
