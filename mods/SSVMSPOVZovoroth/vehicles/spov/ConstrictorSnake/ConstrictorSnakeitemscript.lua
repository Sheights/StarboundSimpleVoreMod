...
defaultDescription = " It probably wants to give you a hug."

defaultIcon = "/vehicles/spov/ConstrictorSnake/ConstrictorSnakeicon.png"

defaultFrame = "/vehicles/spov/ConstrictorSnake/ConstrictorSnakefront.png:display"
